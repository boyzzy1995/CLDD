            ...
            <div class="wrap-content"><!-- 控制外部灰色块div-->
              <div class="mycont"><!-- 控制外部灰色块div-->
                <div class="mycol"><!-- 控制外部灰色块div-->
                  <!--表单form-->
                  <form class="form-horizontal myform" role="form" id="motifyform">
                    <div class="top-words" >
                    ...
                    <div class="form-group">
                      <label for="time" class="col-sm-2 control-label">司机姓名:</label>
                      <div class="col-sm-10">                     
                        <xsl:element name="input">
                          <xsl:attribute name="type">text</xsl:attribute>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <xsl:element name="input">
                          <xsl:attribute name="type">text</xsl:attribute>
                          <xsl:attribute name="id">Sites</xsl:attribute>
                          <xsl:attribute name="class">form-control</xsl:attribute>
                          <xsl:attribute name="name">Sites</xsl:attribute>
                          <xsl:attribute name="value"><xsl:value-of select="SchemaTable/Sites"/></xsl:attribute>
                        </xsl:element>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <xsl:element name="input">
                          <xsl:attribute name="type">text</xsl:attribute>
                          <xsl:attribute name="id">Insurance</xsl:attribute>
                          <xsl:attribute name="class">form-control</xsl:attribute>
                          <xsl:attribute name="name">Insurance</xsl:attribute>
                          <xsl:attribute name="value"><xsl:value-of select="SchemaTable/Insurance"/></xsl:attribute>
                        </xsl:element>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                       ...
                       <xsl:element name="input">
                        <xsl:attribute name="type">text</xsl:attribute>
                        <xsl:attribute name="id">MOT</xsl:attribute>
                        <xsl:attribute name="class">form-control</xsl:attribute>
                        <xsl:attribute name="name">MOT</xsl:attribute>
                        <xsl:attribute name="value"><xsl:value-of select="SchemaTable/MOT"/></xsl:attribute>
                      </xsl:element>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                     <xsl:element name="input">
                      <xsl:attribute name="type">text</xsl:attribute>
                      <xsl:attribute name="id">Kilometers</xsl:attribute>
                      <xsl:attribute name="class">form-control</xsl:attribute>
                      <xsl:attribute name="name">Kilometers</xsl:attribute>
                      <xsl:attribute name="value"><xsl:value-of select="SchemaTable/Kilometers"/></xsl:attribute>
                    </xsl:element>
                  </div>
                </div>
                ...
                <div class="bottom-btn">
                  <div class="bottom-btn-inside">
                    ...
                    <xsl:element name="input">
                      ...
                      <xsl:attribute name="onclick">carmotify('<xsl:value-of select="SchemaTable/Guid"/>')</xsl:attribute>
                    </xsl:element>
                  </div>
                </div>
              </form>
